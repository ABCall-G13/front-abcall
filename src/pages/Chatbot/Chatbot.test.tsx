...
describe('Receive message document valid', () => {
...
describe('Receive message document invalid', () => {
    test('should receive a message', async () => {
        // Mockear respuesta de Axios
        mockAxiosInstance.get.mockResolvedValueOnce({
            data: {
        ...
        // Buscar el campo de texto y escribir un mensaje
        fireEvent.change(messageInput, { target: { value: '123456r789' } });
        ...
        // Esperar a que el mensaje sea enviado
        await waitFor(() =>
            expect(screen.getByText('123456r789')).toBeInTheDocument()
        );

        // Esperar a que el mensaje de respuesta sea recibido
        await waitFor(() =>
            expect(screen.getByText('El número de identificación debe ser un valor numérico. Inténtalo de nuevo.')).toBeInTheDocument()
        );
    });
});
