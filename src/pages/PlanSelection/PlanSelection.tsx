      ...
      <div 
        ...
        >
          ...
          <p>¡Optimiza tu atención telefónica y resuelve problemas rápidamente!
            Ofrece a tus clientes un servicio profesional para gestionar sus solicitudes, con automatización y seguimiento continuo.</p>
          <ul>
            <li>Canales: Teléfono</li>
            <li>Registro y gestión de PQRs</li>
            <li>Automatización de escalamiento de problemas</li>
            <li>Notificaciones por correo, SMS o llamada</li>
            <li>Acceso a la app para seguimiento de incidentes</li>
          </ul>
        </div>
          <div className="plan-footer">
            <button className="select-button emprendedor">Comprar</button>
        ...
        <div 
          ...
          <div className="plan-card-content">
            <p>¡Impulsa tu negocio con la última tecnología en inteligencia artificial y analítica predictiva!
              Resuelve problemas antes de que ocurran y ofrece experiencias únicas a tus clientes.</p>
              <ul>
                  <li>Canales: Teléfono, chatbot, app móvil, correo electrónico</li>
                  <li>IA y analítica predictiva para atención multicanal</li>
                  <li>Registro y gestión de PQRs</li>
                  <li>Automatización de escalamiento de problemas</li>
                  <li>Notificaciones por correo, SMS o llamada</li>
                  <li>Acceso a la app para seguimiento de incidentes</li>
          ...
          <div className="plan-footer">
            <button className="select-button empresario-plus">Comprar</button>
        ...
        <div className={`plan-card empresario ${selectedPlan === 'empresario' ? 'selected' : ''}`} 
          ...
          <div className="plan-card-content">
            ...
            <div className="plan-footer">
              <button className="select-button empresario">Comprar</button>
