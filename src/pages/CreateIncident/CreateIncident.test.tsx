...
describe('CreateIncident component', () => {
  ...
  test('renders form correctly', async () => {
    ...
    render(<CreateIncident onClose={mockOnClose} onIncidentCreated={mockOnIncidentCreated} />);
...
test('submits the form with valid data', async () => {
    ...
    await waitFor(() => {
      expect(axiosInstance.post).toHaveBeenCalledWith('/incidente', expect.any(Object));
    });
  });
  ...
  test('shows error message when submission fails', async () => {
    ...
    mockAxiosInstance.post.mockRejectedValue(new Error('Error al crear incidente'));
