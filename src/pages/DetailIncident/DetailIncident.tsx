...
const DetailIncidentModal: React.FC<DetailIncidentModalProps> = ({ isOpen, onClose, incidentDetail, onIncidentUpdated }) => {
  ...
  const handleSolucionar = () => {
    axiosInstance.put(`/incidente/${incidentDetail.id}/solucionar`,  {solucion} )
      .then(response => {
  ...
  const handleEscalar = () => {
    axiosInstance.put(`/incidente/${incidentDetail.id}/escalar`)
      .then(response => {
    ...
    <div className="modal-backdrop">
      <div className="modal-content">
        ...
        <div className="incident-details">
          ...
          <div className="scroll-container">
            <div>{incidentDetail.solucion || 'Aún no se ha proporcionado una solución.'}</div>
          </div>
          ...
          {incidentDetail.estado === 'abierto' && (
            <div className="incident-actions">
              ...
              />
              <button onClick={handleSolucionar} className="btn-solucionar">
                Guardar Solución
              </button>
              <button onClick={handleEscalar} className="btn-escalar">
                Escalar
              </button>
            </div>
          )}
