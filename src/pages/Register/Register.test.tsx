...
describe('Register Component', () => {
    ...
    test('submits the form with correct data', async () => {
        ...
        fireEvent.change(screen.getByLabelText(/Nombre empresa/i), {
            target: { value: 'Mi Empresa' },
        });
        fireEvent.change(screen.getByLabelText(/Correo electrónico/i), {
            target: { value: 'test@correo.com' },
        });
        fireEvent.change(screen.getByLabelText(/NIT/i), {
        ...
        fireEvent.change(screen.getByLabelText(/Industria/i), {
        ...
        fireEvent.change(
            screen.getByLabelText(/Bienvenida para los Usuarios/i),
            { target: { value: 'Bienvenido a nuestro servicio!' } }
        );
    ...
    test('sets phoneError when phone number contains non-numeric characters', () => {
        ...
        expect(
            screen.getByText('El teléfono solo puede contener números.')
        ).toBeInTheDocument();
    });
